...
<?php if ($configObject->version != $currVersion) { ?>
						<h4><?php echo $configObject->version; ?><a href="http://www.mamp.info">&nbsp;&nbsp;=&gt;&nbsp;<?php printf(tr('Update (%s) available!'), $feed->currentVersion);?></a></h4>
<?php } else { ?> 
						<h4><?php echo $configObject->version; ?>&nbsp;&nbsp;=&gt;&nbsp;<?php echo tr('Your version is up-to-date.');?></h4>
<?php } ?>  
					</div>
					<div class="frame">          
...
<?php } ?>                                                    
			...
			<footer style="margin-top:40px;">
				...
				<p>&copy; 2013 <a href="http://www.appsolute.de">appsolute GmbH</a></p>
			</footer>
		</div><!-- /.container -->
